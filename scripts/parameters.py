...
# Kyber round 3
KYBER512r3 = ("r3/kyber512", Kyber(256, 2, 3, 3329, 2**12, 2**10, 2**4))
KYBER768r3 = ("r3/kyber768", Kyber(256, 3, 2, 3329, 2**12, 2**10, 2**4))
KYBER1024r3 = ("r3/kyber1024", Kyber(256, 4, 2, 3329, 2**12, 2**11, 2**5))
# Frodo
